...
import SalaryByMonth from "../../views/user/view/SalaryByMonth"
import UserViewSpecificDetail from "../../views/user/view/userViewDetail"
...
const Routes = [
  ...
  {
    path: "/QuanLyLuong",
    element: <SalaryByMonth />
  },
  {
    path: "/QuanLyNgayCong",
    element: <UserViewSpecificDetail />
  },
  {
    path: "/user/:handle/:id",
    element: <AddEditUser />
